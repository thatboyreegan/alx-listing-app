...
This app invloves the creation of an Airbnb clone listing page.

The components folder in the app directory is for holding all the components. The common folder with in it holds the components common in the pages.  
